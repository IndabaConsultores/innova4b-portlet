...
public class Innova4bPortlet extends MVCPortlet {
	...
	public void accion1(ActionRequest actionRequest,
	...
	public void accion2(ActionRequest actionRequest,
			ActionResponse actionResponse) {
	...
	public void saveLibro(ActionRequest actionRequest,
			ActionResponse actionResponse) {
		...
		try {
			Libro libro = null;
			if (libroId == 0) {
				libro = LibroLocalServiceUtil
						.createLibro(CounterLocalServiceUtil.increment());
			}else{
				libro = LibroLocalServiceUtil
						.getLibro(libroId);
			}
